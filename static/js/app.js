...
var $loadingSpinner, $lol, campusTable, courseStatusTable, courseTypeTable, currentTerm, currentYear, examineTypeTable, getData, loadClassesToday, toggleLoadingScene;
...
toggleLoadingScene = function(selector, html, animation) {
  if (animation == null) {
    animation = false;
  }
  if (animation) {
