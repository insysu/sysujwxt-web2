...
(function() {
  var calculateGpa, drawBarChart, drawBubbleChart, drawChart, drawPieChart, exports, formatScoreForBar, formatScoreForPie, genCreditRow, genGChartUrl, getDistributedScore, getEarnedCredit, getGpa, getRequiredCredit, getScore, getScript, getTno, organizeCredits;
  ...
  calculateGpa = function(scores) {
    var gpa, gpaWeight, score, totalCredits, zzcj, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
    gpaWeight = 0;
    totalCredits = 0;
    ...
    for (_j = 0, _len1 = scores.length; _j < _len1; _j++) {
      score = scores[_j];
      if ((85 <= (_ref = score.zzcj) && _ref <= 100)) {
        zzcj = 4.0;
      } else if ((80 <= (_ref1 = score.zzcj) && _ref1 <= 84)) {
        zzcj = 3.5;
      } else if ((75 <= (_ref2 = score.zzcj) && _ref2 <= 79)) {
        zzcj = 3.0;
      } else if ((70 <= (_ref3 = score.zzcj) && _ref3 <= 74)) {
        zzcj = 2.5;
      } else if ((65 <= (_ref4 = score.zzcj) && _ref4 <= 69)) {
        zzcj = 2.0;
      } else if ((60 <= (_ref5 = score.zzcj) && _ref5 <= 64)) {
        zzcj = 1.5;
  ...
  drawBubbleChart = function(scores, ele) {
  ...
  $(function() {
    ...
    return $(".chart-type-btn-group button[value=pie]").click();
  });
